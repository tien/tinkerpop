...
import { deepMembersById, compareElements, opt } from '../cucumber/element-comparison.js';
...
describe('objects', function () {
  ...
  const path1 = new Path(['path'], [new Vertex(1, 'person', undefined), new Vertex(2, 'person', undefined)]);
  const path2 = new Path(['path'], [new Vertex(1, 'person', undefined)]);
  const path3 = new Path(['path'], [new Vertex(2, 'person', undefined), new Vertex(1, 'person', undefined)]);
